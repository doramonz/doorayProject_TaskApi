...
public interface MileStoneRepository extends JpaRepository<MileStone, Integer>{
    ...
    @Query("SELECT new com.nhnacademy.doorayProject.dto.MileStoneIdNameDto(m.mileStoneId, m.mileStoneName) FROM MileStone m JOIN Project p on m.project.projectId = p.projectId WHERE p.projectId = :projectId")
